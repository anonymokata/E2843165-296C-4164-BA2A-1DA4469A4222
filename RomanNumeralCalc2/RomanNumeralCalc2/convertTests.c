...
#line 31
	...
	ck_assert_msg(strcmp(convertIntToRomanNumeral(3200),  "MMMCC") == 0,"Failed to convert 3200 to MMMCC");
	ck_assert_msg(strcmp(convertIntToRomanNumeral(65),  "LXV") == 0,"Failed to convert 3200 to MMMCC");
}
END_TEST
